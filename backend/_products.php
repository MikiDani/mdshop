...
if (($products != null) && ($products != "none")) {
    ...
    foreach ($products as $product) {
        ...
        echo '<form method="post" action="index.php"><input type="hidden" name="productid" value="'.$product->id.'"><input type="hidden" name="accordion-num" value="'.$num.'"><table class="table verticalalign"><tr><td>'.$product->id.'.</td><td>típus:</td><td><div class="d-flex align-items-center"><select name="typeid" class="form-select w-75 me-2">';
        // product type list
        ...
        if ($product->markdown !== 0) {
            ...
            echo '<tr><td></td><td>Akciós ár:</td><td><div class="d-flex align-items-center"><div class="w-75 ms-2 text-danger"><strong>'.$lowPrice.'</strong></div></div></tr>';
        }
